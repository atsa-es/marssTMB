...
#' For `form="dfa"`, `m` can be passed in, e.g. `m=3`, to specify the number of hidden state variables (factors).
#' 
...
#'   }
#' @references The MARSS User Guide:  Holmes, E. E., E. J. Ward, and M. D. Scheuerell (2012) Analysis of multivariate time-series using the MARSS package. NOAA Fisheries, Northwest Fisheries Science Center, 2725 Montlake Blvd E., Seattle, WA 98112     
#' @author Eli Holmes
#' @export
marssTMB.dfa <- function(marssTMB.call) {
  ...
  # Check that no args were passed in that are not allowed
